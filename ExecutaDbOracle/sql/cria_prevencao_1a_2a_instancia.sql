...
CREATE PUBLIC SYNONYM TJRJ_TP_ORIGEM_PREVENCAO FOR TJRJ.TJRJ_TP_ORIGEM_PREVENCAO;
...
FOREIGN KEY (TPRV_ORGI_DK) REFERENCES ORGI.ORGI_ORGAO (ORGI_DK);
...
CREATE PUBLIC SYNONYM TJRJ_PREVENCAO FOR TJRJ.TJRJ_PREVENCAO;
...
CREATE PUBLIC SYNONYM TJRJ_SQ_TPRV_DK FOR TJRJ.TJRJ_SQ_TPRV_DK;
